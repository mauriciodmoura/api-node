...
export class Default1688596762012 implements MigrationInterface {
    name = 'Default1688596762012'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cars_image" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "car_id" character varying NOT NULL, "image_name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d51cd9b574666d7b4597fbb1604" PRIMARY KEY ("id"))`);
